...
//TODO Someday remove need for this class and do everything in EmojyGenerator.kt
open class GifDecoder {
    ...
    private var image: BufferedImage? = null // current frame
    ...
    private fun read() = runCatching { `in`?.read() }.getOrNull() ?: 0
