...
class EmojyCommands : IdofrontCommandExecutor(), TabCompleter {
    override val commands = commands(emojy.plugin) {
        "emojy" {
            "test" {
                action {
                    sender.info(GlobalTranslator.render("<lang:mineinabyss.tutorial.welcome.1>".miniMsg(), Locale.US))
                    sender.info(GlobalTranslator.render("<lang:mineinabyss.tutorial.welcome.2>".miniMsg(), Locale.US))
                    sender.info(GlobalTranslator.render("<lang:mineinabyss.tutorial.welcome.3>".miniMsg(), Locale.US))
                }
            }
            "list" {
                action {
